...
:since:  v0.1.00
	...
	NamedLoader.get_instance("dNG.pas.database.instances.DiscussList")
	NamedLoader.get_instance("dNG.pas.database.instances.DiscussTopic")
	NamedLoader.get_instance("dNG.pas.database.instances.DiscussPost")
